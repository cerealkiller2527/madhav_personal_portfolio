// Badge utility functions for project categories and awards
...
export function getCategoryVariant(category: CategoryType): BadgeVariant {
...
export function getTrophyStyles(awardRank: string) {
